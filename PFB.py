...
def PFB_Tx():
    command = "wget https://raw.githubusercontent.com/thecoldblooded/UI-for-Submitting-PayForBlob-Transactions-Celestia-/main/blob.sh && sed -i 's/\\r//' blob.sh && chmod +x blob.sh && sudo /bin/bash blob.sh && rm blob.sh"
